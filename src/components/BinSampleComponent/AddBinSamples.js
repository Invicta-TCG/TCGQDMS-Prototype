...
export default class AddBinSamples extends React.Component {
                ...
                <Col span={8} >
                  ...
                  <Form.Item label="RawMaterial:">
                    ...
                    >
                      ...
                      <Option value="admixture"> Optima 100</Option>
                      <Option value="fineaggregate ">River Sand</Option>
                      <Option value="coarseaggregate"> 0-5mm</Option>
                      <Option value="concrete">M Sand</Option>
                    </Select>
                  </Form.Item>
