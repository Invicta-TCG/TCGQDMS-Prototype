...
import { Table, AutoComplete, Input, Icon, Modal, Row, Col, Pagination, Card,Popconfirm,Divider,Breadcrumb } from 'antd';
...
export default class ManageCustomers extends React.Component {
  state = {
    filteredInfo: null,
    sortedInfo: null,
    searchText: '',
...
<a href="#"><Icon type="delete"></Icon></a>
    ...
    return (
      ...
      <Breadcrumb style={{
        ...
        <Breadcrumb.Item>ManageCustomer</Breadcrumb.Item>
